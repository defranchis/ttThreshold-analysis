...
(power-left $+$ exp-right) reduces the inclusive \chitndf from
$\{3.7, 3.5, 3.5\}$ to $\{2.0, 2.2, 2.1\}$ at the three energies, with
visibly flatter pull distributions
(Fig.~\ref{fig:lep-p-resp-compare}).
...
\begin{figure}[ht]
  ...
  \caption{Lepton $p$-response fit at \sqs=160~GeV: legacy
    ...
    \chitndf improves from 3.5 to 2.2 and the structured pull pattern
...
\begin{figure}[ht]
  ...
  \caption{Updated \codename{dcber2g} fit at all three ECMs.
    \chitndf $\in \{1.99, 2.16, 2.08\}$ vs.\ the previous
